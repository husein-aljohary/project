    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imageView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                requestImage();imageView.setTag("yes");
            }
        });
        ...
        imageView2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                requestImage2();imageView2.setTag("yes");
            }
        });
            ...
            public void onClick(View view) {
              ...
              // sp.setId(teparksnumber.getText().toString());
               // mallinfo1.setSpace(sp);
                    ...
                    if (imageView.getTag().equals("bg1") || imageView2.getTag().equals("bg2")){
        ...
        Delete.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent myIntent = new Intent(cities.this, com.example.myapplication.Admin.Delete.class);
